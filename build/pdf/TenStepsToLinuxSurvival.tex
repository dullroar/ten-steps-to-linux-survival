...
(\emph{concatenate}) command: \drcmd{cat}
...
\item
  ...
  \href{http://github.com}{GitHub}. \drcmd{git}
\item
  \textbf{\texttt{cmake}} and \textbf{\texttt{make}} - configuring and
  building software from source. \drcmd{cmake} \drcmd{make}
\end{enumerate}

A better way to display a longer file is to use the
\href{http://linux.die.net/man/1/less}{\texttt{less}}
