...
\href{http://creativecommons.org/licenses/by-sa/4.0/}{Creative Commons}
licenses, such as the books from \href{http://greenteapress.com/}{Green
Tea Press}. If you like those big, thick tech books that are measured by
the kilogram, this is not the book for you.
...
\texttt{/etc/passwd}). By default, \texttt{man\ passwd} will show you
the documentation from the lowest numbered section with a match, in this
