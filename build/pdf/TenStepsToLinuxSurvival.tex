...
\item
  ...
  \drdis{Debian} \drdis{Fedora} \drdis{Yellow Dog} \drdis{Ubuntu}
  \drdis{Kubuntu} \drdis{Xubuntu} \drdis{Mint} \drdis{Raspbian}
  \drdis{Gentoo} \drdis{Red Hat} \drdis{Slackware}
\item
  \textbf{Solaris}
\item
  \textbf{SunOS}
...
system, especially in production. \drcmd{rm}
\index{files and directories!delete (\texttt{rm} command)} \dreds{vi}
...
these by using \texttt{less}, redirection and the like. \drnet{ssh}
\drcmd{less}
...
command. \drshl{csh} \drshl{bash} \drenv{PS1}{command prompt string}
...
\item
  ...
  \href{https://en.wikipedia.org/wiki/NetBSD}{NetBSD}, \drbsd{NetBSD}
  \href{https://en.wikipedia.org/wiki/FreeBSD}{FreeBSD} \drbsd{FreeBSD}
  and \href{https://en.wikipedia.org/wiki/OpenBSD}{OpenBSD}.
  \drbsd{OpenBSD} All happen in the same time frame as Linux. Like Linux
...
Versus the "same" command on a FreeBSD \drbsd{FreeBSD} system at my ISP,
...
\drios{Linux} \drbsd{FreeBSD} \drbsd{OpenBSD} \drbsd{NetBSD}
...
\item
  \textbf{\texttt{pacman}} - \drpkg{pacman}
  \href{https://en.wikipedia.org/wiki/Arch_Linux}{Arch} \drdis{Arch}
  flavors.
\item
  \textbf{\texttt{rpm} and \texttt{yum}} - \drpkg{rpm} \drpkg{yum} Red
  Hat \drdis{Red Hat} flavors,such as
