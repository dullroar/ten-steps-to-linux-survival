...
\DeclareRobustCommand{\ishell}[1]{\index{Shells!#1}}
...
The \texttt{sort} command \fref{sort} to the rescue!

\ifxetex\fimg{./images/sort.png}{sort command}{sort} \else
\includegraphics{./images/sort.png} \fi

What if we want to sort by the parts column? Well, it is the second
``key'' field delimited by whitespace~\fref{sort-k2}, so:

\ifxetex\fimg{./images/sort-k2.png}{Sort by second column}{sort-k2}
\else
\includegraphics{./images/sort-k2.png} \fi

What about by the third column, the amount? \fref{sort-k3}

\ifxetex\fimg{./images/sort-k3.png}{Sort by third column}{sort-k3} \else
\includegraphics{./images/sort-k3.png} \fi

That's not what we expected because it is sorting numbers
alphabetically. Let's fix that \fref{sort-k3-n} by telling it to sort
numerically.

\ifxetex\fimg{./images/sort-k3-n.png}{Sort by third column, numerically}{sort-k3-n}
\else
\includegraphics{./images/sort-k3-n.png} \fi
