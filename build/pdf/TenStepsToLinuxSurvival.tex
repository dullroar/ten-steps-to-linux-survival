...
\drcmd{bash} \drnet{curl} \drnet{wget}
...
of course you can \texttt{man\ man}! \drcmd{less} \drdoc{man}
\index{files and directories!paginate!less@\texttt{less} command}
\index{pagination!\texttt{less} command}
...
\item
  ...
  language for processing streams of data. \drcmd{awk}
\item
  \href{http://linux.die.net/man/1/bash}{\textbf{\texttt{bash}}} - the
  Bourne-again shell. \drcmd{bash}
\item
...
\item
  ...
  concatenate the input files to \emph{stdout}. \drcmd{cat}
  \drstd{stdout}
\item
...
\item
  ...
  change the primary group of a file or directory. \drcmd{chgrp}
\item
...
\item
  ...
  change the owner of a file or directory. \drcmd{chown}
\item
...
\item
  ...
  display passed parameters to \emph{stdout}. \drcmd{echo}
  \drstd{stdout}
\item
...
\item
  ...
  display the file one page at a time on \emph{stdout}. \drcmd{less}
  \drstd{stdout}
  \index{files and directories!paginate!less@\texttt{less} command}
  \index{pagination!\texttt{less} command}
\item
...
\item
  ...
  display the file one page at a time on \emph{stdout}. \drcmd{more}
  \drstd{stdout}
  \index{files and directories!paginate!more@\texttt{more} command}
  \index{pagination!\texttt{more} command}
\item
...
\item
  ...
  \emph{stdin} or a file to \emph{stdout}. \drcmd{sort} \drstd{stdin}
  \drstd{stdout}
\item
...
\item
  ...
  display the last lines of a file. \drcmd{tail}
\item
...
\item
  ...
  nothing, successfully. \drcmd{true}
\item
...
\item
  ...
  the answer to life's most existential question. \drcmd{whoami}
\item
...
\item
  ...
  manager for Fedora flavors. \drpkg{rpm}
\item
...
\item
  ...
  execute a command with elevated privileges. \drcmd{sudo}
\item
...
(once I get Dropbox set up on the machine!) \drcmd{if} \drnet{xfreerdp}
...
\drcmd{make} \drcmd{pandoc} \drcmd{pdflatex} \drcmd{texlive}
